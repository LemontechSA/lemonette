...
@Lemonette.UpdateEventListener = (outstandingId, models) ->
...
_.extend @Lemonette.UpdateEventListener::, Backbone.Events,
  _onModelSync: (model) ->
...
###
class @Lemonette.LiveCollection extends Backbone.Collection
